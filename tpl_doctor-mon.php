<?php /*
Template Name: Caribbean Doctor Mon Blog Page
*/ ?>
    ...
    <div class="page-container">
        <div class="page-hero">
          <div id="home" class="page-banner">
            <div class="page-title">
              ...
              <img class="page-img" src="<?php bloginfo('template_directory'); ?>/images/Dr-mon-logo.png" alt="Dr. Mon Logo">
            </div>
          </div>
        </div>
        <div class="single-wrapper row">
          <div class="main-content col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
            <?php
              query_posts('post_type=post&post_status=publish&posts_per_page=100&paged=&category_name=Caribbean Doctor Mon'.get_query_var('pages'));
